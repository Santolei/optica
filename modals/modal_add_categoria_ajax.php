<!-- Modal de Categoría -->
<div class="modal fade" id="modal_add_categoria_ajax" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-notify modal-info" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add_categoria_ajax" action="consultas/add_categoria.php" method="POST">
